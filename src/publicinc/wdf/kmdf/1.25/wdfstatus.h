...
//
// MessageId: STATUS_WDF_TOO_MANY_TRANSFERS
//
// MessageText:
//
// The DMA transaction requires more DMA transfers than the limit specified by the driver.
//
#define STATUS_WDF_TOO_MANY_TRANSFERS    ((NTSTATUS)0xC0200213L)

//
// MessageId: STATUS_WDF_NOT_ENOUGH_MAP_REGISTERS
//
// MessageText:
//
// Not enough map registers are available to perform the DMA transaction in the manner specified by the driver.
//
#define STATUS_WDF_NOT_ENOUGH_MAP_REGISTERS ((NTSTATUS)0xC0200214L)
