    ...
    )
{
    ...
    Config->Size = WDF_STRUCTURE_SIZE(WDF_WMI_PROVIDER_CONFIG);
    ...
    )
{
    ...
    Config->Size = WDF_STRUCTURE_SIZE(WDF_WMI_INSTANCE_CONFIG);
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFWMIPROVIDERCREATE)(
    _In_
...
WDFAPI
WDFDEVICE
(NTAPI *PFN_WDFWMIPROVIDERGETDEVICE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFWMIPROVIDER WmiProvider
...
WDFAPI
BOOLEAN
(NTAPI *PFN_WDFWMIPROVIDERISENABLED)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFWMIPROVIDER WmiProvider,
...
WDFAPI
ULONGLONG
(NTAPI *PFN_WDFWMIPROVIDERGETTRACINGHANDLE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFWMIPROVIDER WmiProvider
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFWMIINSTANCECREATE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFDEVICE Device,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFWMIINSTANCEREGISTER)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFWMIINSTANCE WmiInstance
...
WDFAPI
VOID
(NTAPI *PFN_WDFWMIINSTANCEDEREGISTER)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFWMIINSTANCE WmiInstance
...
WDFAPI
WDFDEVICE
(NTAPI *PFN_WDFWMIINSTANCEGETDEVICE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFWMIINSTANCE WmiInstance
...
WDFAPI
WDFWMIPROVIDER
(NTAPI *PFN_WDFWMIINSTANCEGETPROVIDER)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFWMIINSTANCE WmiInstance
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFWMIINSTANCEFIREEVENT)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFWMIINSTANCE WmiInstance,
