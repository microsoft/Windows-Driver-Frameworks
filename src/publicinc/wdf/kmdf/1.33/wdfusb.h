...

{
    ...
    Config->Size = WDF_STRUCTURE_SIZE(WDF_USB_CONTINUOUS_READER_CONFIG);
    ...
    )
{
    ...
    Udi->Size = WDF_STRUCTURE_SIZE(WDF_USB_DEVICE_INFORMATION);
}
    ...
    )
{
    ...
    Params->Size = WDF_STRUCTURE_SIZE(WDF_USB_DEVICE_SELECT_CONFIG_PARAMS);
    ...
    )
{
    ...
    Params->Size = WDF_STRUCTURE_SIZE(WDF_USB_INTERFACE_SELECT_SETTING_PARAMS);
    ...
    )
{
    ...
    Info->Size = WDF_STRUCTURE_SIZE(WDF_USB_PIPE_INFORMATION);
}
    ...
    )
{
    ...
    Config->Size = WDF_STRUCTURE_SIZE(WDF_USB_DEVICE_CREATE_CONFIG);
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICECREATE)(
    _In_
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICECREATEWITHPARAMETERS)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFDEVICE Device,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICERETRIEVEINFORMATION)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
VOID
(NTAPI *PFN_WDFUSBTARGETDEVICEGETDEVICEDESCRIPTOR)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICERETRIEVECONFIGDESCRIPTOR)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICEQUERYSTRING)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICEALLOCANDQUERYSTRING)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICEFORMATREQUESTFORSTRING)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
UCHAR
(NTAPI *PFN_WDFUSBTARGETDEVICEGETNUMINTERFACES)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICESELECTCONFIG)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
(NTAPI *PFN_WDFUSBTARGETDEVICEWDMGETCONFIGURATIONHANDLE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICERETRIEVECURRENTFRAMENUMBER)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICESENDCONTROLTRANSFERSYNCHRONOUSLY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICEFORMATREQUESTFORCONTROLTRANSFER)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICEISCONNECTEDSYNCHRONOUS)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICERESETPORTSYNCHRONOUSLY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICECYCLEPORTSYNCHRONOUSLY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICEFORMATREQUESTFORCYCLEPORT)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICESENDURBSYNCHRONOUSLY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICEFORMATREQUESTFORURB)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICEQUERYUSBCAPABILITY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICECREATEURB)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETDEVICECREATEISOCHURB)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
VOID
(NTAPI *PFN_WDFUSBTARGETPIPEGETINFORMATION)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
BOOLEAN
(NTAPI *PFN_WDFUSBTARGETPIPEISINENDPOINT)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe
...
WDFAPI
BOOLEAN
(NTAPI *PFN_WDFUSBTARGETPIPEISOUTENDPOINT)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe
...
WDFAPI
WDF_USB_PIPE_TYPE
(NTAPI *PFN_WDFUSBTARGETPIPEGETTYPE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe
...
WDFAPI
VOID
(NTAPI *PFN_WDFUSBTARGETPIPESETNOMAXIMUMPACKETSIZECHECK)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPEWRITESYNCHRONOUSLY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPEFORMATREQUESTFORWRITE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPEREADSYNCHRONOUSLY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPEFORMATREQUESTFORREAD)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPECONFIGCONTINUOUSREADER)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPEABORTSYNCHRONOUSLY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPEFORMATREQUESTFORABORT)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPERESETSYNCHRONOUSLY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPEFORMATREQUESTFORRESET)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPESENDURBSYNCHRONOUSLY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE Pipe,
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBTARGETPIPEFORMATREQUESTFORURB)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE PIPE,
...
WDFAPI
BYTE
(NTAPI *PFN_WDFUSBINTERFACEGETINTERFACENUMBER)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBINTERFACE UsbInterface
...
WDFAPI
BYTE
(NTAPI *PFN_WDFUSBINTERFACEGETNUMENDPOINTS)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBINTERFACE UsbInterface,
...
WDFAPI
VOID
(NTAPI *PFN_WDFUSBINTERFACEGETDESCRIPTOR)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBINTERFACE UsbInterface,
...
WDFAPI
BYTE
(NTAPI *PFN_WDFUSBINTERFACEGETNUMSETTINGS)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBINTERFACE UsbInterface
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFUSBINTERFACESELECTSETTING)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBINTERFACE UsbInterface,
...
WDFAPI
VOID
(NTAPI *PFN_WDFUSBINTERFACEGETENDPOINTINFORMATION)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBINTERFACE UsbInterface,
...
WDFAPI
WDFUSBINTERFACE
(NTAPI *PFN_WDFUSBTARGETDEVICEGETINTERFACE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBDEVICE UsbDevice,
...
WDFAPI
BYTE
(NTAPI *PFN_WDFUSBINTERFACEGETCONFIGUREDSETTINGINDEX)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
...
WDFAPI
BYTE
(NTAPI *PFN_WDFUSBINTERFACEGETNUMCONFIGUREDPIPES)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBINTERFACE UsbInterface
...
WDFAPI
WDFUSBPIPE
(NTAPI *PFN_WDFUSBINTERFACEGETCONFIGUREDPIPE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBINTERFACE UsbInterface,
...
WDFAPI
USBD_PIPE_HANDLE
(NTAPI *PFN_WDFUSBTARGETPIPEWDMGETPIPEHANDLE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFUSBPIPE UsbPipe
