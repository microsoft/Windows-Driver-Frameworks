...
// 
// Will return a valid pointer if TypeInfo is associated with the Handle, otherwise
// NULL.
// 
...
// 
// Will return a WDFOBJECT from a given context pointer, e.g.
// 
// WDFDEVICE device;
// PDEVICE_CONTEXT pContext;
// 
// device = (WDFDEVICE) WdfObjectContextGetObject(pContext);
// 
