    ...
    )
{
    ...
    Params->Size = WDF_STRUCTURE_SIZE(WDF_DRIVER_VERSION_AVAILABLE_PARAMS);
...
//
// WDF Function: WdfDriverErrorReportApiMissing
//
typedef
_Must_inspect_result_
...
WDFAPI
NTSTATUS
(*PFN_WDFDRIVERERRORREPORTAPIMISSING)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFDRIVER Driver,
...
{
    return ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, Driver, FrameworkExtensionName, ApiIndex, DoesApiReturnNtstatus);
}


//
// WDF Function: WdfDriverOpenPersistentStateRegistryKey
//
typedef
_Must_inspect_result_
_IRQL_requires_max_(PASSIVE_LEVEL)
WDFAPI
NTSTATUS
(*PFN_WDFDRIVEROPENPERSISTENTSTATEREGISTRYKEY)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFDRIVER Driver,
...
{
    return ((PFN_WDFDRIVEROPENPERSISTENTSTATEREGISTRYKEY) WdfFunctions[WdfDriverOpenPersistentStateRegistryKeyTableIndex])(WdfDriverGlobals, Driver, DesiredAccess, KeyAttributes, Key);
}


//
// WDF Function: WdfDriverRetrieveDriverDataDirectoryString
//
typedef
_IRQL_requires_max_(PASSIVE_LEVEL)
WDFAPI
NTSTATUS
(*PFN_WDFDRIVERRETRIEVEDRIVERDATADIRECTORYSTRING)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFDRIVER Driver,
    ...
    )
{
    ...
    return ((PFN_WDFDRIVERRETRIEVEDRIVERDATADIRECTORYSTRING) WdfFunctions[WdfDriverRetrieveDriverDataDirectoryStringTableIndex])(WdfDriverGlobals, Driver, String);
#else
    if (WDF_IS_FUNCTION_AVAILABLE(WdfDriverRetrieveDriverDataDirectoryString)) {
        return ((PFN_WDFDRIVERRETRIEVEDRIVERDATADIRECTORYSTRING) WdfFunctions[WdfDriverRetrieveDriverDataDirectoryStringTableIndex])(WdfDriverGlobals, Driver, String);
    }
    else {
        return ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NULL, WdfDriverRetrieveDriverDataDirectoryStringTableIndex, TRUE);
    }
#endif
}
