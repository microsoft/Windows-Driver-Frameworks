...
//
// WDF Function: WdfDmaTransactionSetSingleTransferRequirement
//
typedef
_IRQL_requires_max_(DISPATCH_LEVEL)
WDFAPI
...
{
    ((PFN_WDFDMATRANSACTIONSETSINGLETRANSFERREQUIREMENT) WdfFunctions[WdfDmaTransactionSetSingleTransferRequirementTableIndex])(WdfDriverGlobals, DmaTransaction, RequireSingleTransfer);
}
