    ...
    )
{
    ...
    if (SUCCEEDED(hrQI)) {
        UMDF_HOST::WDF_REQUEST_TYPE type;
        
        //
        // for Io irp, map request type to major funcction
        //
        type = (UMDF_HOST::WDF_REQUEST_TYPE) pIoIrp->GetType();
        switch(type) {
        case  UMDF_HOST::WdfRequestCreate:
            majorFunction = IRP_MJ_CREATE;
            break;
        case  UMDF_HOST::WdfRequestCleanup:
            majorFunction = IRP_MJ_CLEANUP;
            break;
        case  UMDF_HOST::WdfRequestRead:
            majorFunction = IRP_MJ_READ;
            break;
        case  UMDF_HOST::WdfRequestWrite:
            majorFunction = IRP_MJ_WRITE;
            break;
        case  UMDF_HOST::WdfRequestDeviceIoControl:
            majorFunction = IRP_MJ_DEVICE_CONTROL;
            break;
        case  UMDF_HOST::WdfRequestClose:
            majorFunction = IRP_MJ_CLOSE;
            break;
        case  UMDF_HOST::WdfRequestInternalIoctl:
            majorFunction = IRP_MJ_INTERNAL_DEVICE_CONTROL;
            break;
        case UMDF_HOST::WdfRequestFlushBuffers:
            majorFunction = IRP_MJ_FLUSH_BUFFERS;
            break;
        case UMDF_HOST::WdfRequestQueryInformation:
            majorFunction = IRP_MJ_QUERY_INFORMATION;
            break;
        case UMDF_HOST::WdfRequestSetInformation:
            majorFunction = IRP_MJ_SET_INFORMATION;
            break;
        case  UMDF_HOST::WdfRequestUsb:
        case  UMDF_HOST::WdfRequestOther:
            // fall through
        default:
    ...
    )
{
    ...
    if (SUCCEEDED(hrQI)) {
        ...
        case IRP_MJ_CREATE:
            type = UMDF_HOST::WdfRequestCreate;
            break;
        case IRP_MJ_CLEANUP:
            type = UMDF_HOST::WdfRequestCleanup;
            break;
        case IRP_MJ_READ:
            type = UMDF_HOST::WdfRequestRead;
            break;
        case IRP_MJ_WRITE:
            type = UMDF_HOST::WdfRequestWrite;
            break;
        case IRP_MJ_DEVICE_CONTROL:
            type = UMDF_HOST::WdfRequestDeviceIoControl;
            break;
        case IRP_MJ_CLOSE:
            type = UMDF_HOST::WdfRequestClose;
            break;
        case IRP_MJ_INTERNAL_DEVICE_CONTROL:
            type = UMDF_HOST::WdfRequestInternalIoctl;
            break;
        case IRP_MJ_FLUSH_BUFFERS:
            type = UMDF_HOST::WdfRequestFlushBuffers;
            break;
        case IRP_MJ_QUERY_INFORMATION:
            type = UMDF_HOST::WdfRequestQueryInformation;
            break;
        case IRP_MJ_SET_INFORMATION:
            type = UMDF_HOST::WdfRequestSetInformation;
            break;
        default:
            FX_VERIFY(INTERNAL, TRAPMSG("The request type is not expected"));
            type = UMDF_HOST::WdfRequestUndefined;
        }

        pIoIrp->SetTypeForNextStackLocation((WDF_REQUEST_TYPE)type);
        pIoIrp->Release();
    }
    else {
