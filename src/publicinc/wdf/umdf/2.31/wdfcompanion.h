    ...
    )
{
    ...
    Callbacks->Size = WDF_STRUCTURE_SIZE(WDF_COMPANION_EVENT_CALLBACKS);
}
    ...
    )
{
    ...
    Config->Size = WDF_STRUCTURE_SIZE(WDF_TASK_QUEUE_CONFIG);
...
WDFAPI
VOID
(NTAPI *PFN_WDFDEVICEINITSETCOMPANIONEVENTCALLBACKS)(
    _In_
...
WDFAPI
HANDLE
(NTAPI *PFN_WDFCOMPANIONWDMGETSECUREDEVICEHANDLE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFCOMPANION Companion
...
WDFAPI
NTSTATUS
(NTAPI *PFN_WDFCOMPANIONCREATETASKQUEUE)(
    _In_
    PWDF_DRIVER_GLOBALS DriverGlobals,
    _In_
    WDFCOMPANION Companion,
