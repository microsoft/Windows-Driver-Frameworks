...
//
// WDF Function: WdfPdoInitRemovePowerDependencyOnParent
//
typedef
_IRQL_requires_max_(PASSIVE_LEVEL)
WDFAPI
    ...
    )
{
    ...
    ((PFN_WDFPDOINITREMOVEPOWERDEPENDENCYONPARENT) WdfFunctions[WdfPdoInitRemovePowerDependencyOnParentTableIndex])(WdfDriverGlobals, DeviceInit);
#else
    if (WDF_IS_FUNCTION_AVAILABLE(WdfPdoInitRemovePowerDependencyOnParent)) {
        ((PFN_WDFPDOINITREMOVEPOWERDEPENDENCYONPARENT) WdfFunctions[WdfPdoInitRemovePowerDependencyOnParentTableIndex])(WdfDriverGlobals, DeviceInit);
    }
    else {
        ((PFN_WDFDRIVERERRORREPORTAPIMISSING) WdfFunctions[WdfDriverErrorReportApiMissingTableIndex])(WdfDriverGlobals, WdfGetDriver(), NULL, WdfPdoInitRemovePowerDependencyOnParentTableIndex, FALSE);
    }
#endif
}
